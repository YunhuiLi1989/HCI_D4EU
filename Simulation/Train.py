...
parser.add_argument("--trainset_num", default=6000, type=int, help='The number of training samples of each epoch')
...
parser.add_argument("--scene_num", default=205, type=int, help='The number of scenes of Datasets')
